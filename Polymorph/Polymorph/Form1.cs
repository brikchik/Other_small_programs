...
namespace Polymorph
{
    public partial class Form1 : Form
    {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception) { active.mas[(int)numericUpDown2.Value] = new temp1(p, g); listBox1.Items.Add("Индикатор 1 типа создан автоматически"); }
        }
    ...
    public abstract class temperatureIndicator
    {
        ...
        protected Exception wrongValue=new Exception("Температура за пределами границ измерения");
    ...
    public class temp3 : temperatureIndicator   //2тип-градусник
    {
        Graphics grBack;
        bool overload = false;//больше 45 не влезает
        Panel panel;
