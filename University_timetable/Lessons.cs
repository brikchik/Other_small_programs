...
namespace lab6_user_oriented_app
{
    public partial class Lessons : Form
    {
        ...
        public Lessons(ListBox.ObjectCollection listbox,ref Lesson l, bool edit)
        {
        ...
        {
            foreach (string o in listboxitems) if (o == textBox1.Text) { textBox1.Text = "name busy"; return; }
